...
const socialLinks = [
  { name: "LinkedIn", url: "https://linkedin.com/company/stemise", icon: LinkedInIcon },
  { name: "Instagram", url: "https://www.instagram.com/stemise_official/", icon: InstagramIcon },
  { name: "TikTok", url: "https://www.tiktok.com/@stemise_official", icon: TikTokIcon },
  { name: "Discord", url: "https://discord.gg/dHYPMrsD8U", icon: DiscordIcon }
];
            ...
            <div className="flex gap-3 mt-6">
              {socialLinks.map(social => (
                <a 
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-secondary hover:bg-primary/20 transition-colors" 

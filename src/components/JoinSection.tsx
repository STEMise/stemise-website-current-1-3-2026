...
const JoinSection = () => {
  ...
  return <section id="join" className="relative py-24 bg-card scroll-mt-24 overflow-hidden">
      {/* Background Image with subtle movement */}
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat animate-[zoomIn_25s_ease-in-out_infinite_alternate]" style={{

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="w-32 h-32 mx-auto mb-4 bg-muted border border-border flex items-center justify-center">
                ...
                <p className="text-foreground/70 text-center text-sm mt-3">
                  {member.bio}
                </p>
                {/* LinkedIn */}
